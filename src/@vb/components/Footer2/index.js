        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <p className="mb-0">
              ...
              <a href="https://AmberGridBots.com" target="_blank" rel="noopener noreferrer">
                AmberGridBots.com
              </a>
              {' | '}
              <a href="https://AmberGridBots.com/privacy" target="_blank" rel="noopener noreferrer">
                Privacy Policy
              </a>
            </p>
          </div>
