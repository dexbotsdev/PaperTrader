    ...
    <div>
      ...
      <div className={`card ${style.container}`}>
        ...
        <div className="mb-4">
          Login and password
          <br />
          <strong>demo@papertrader.io / papertrader.io</strong>
        </div> 
        <Form
          layout="vertical"
          hideRequiredMark
          ...
          className="mb-4"
          initialValues={{ email: 'demo@papertrader.io', password: 'papertrader.io' }}
        >
          <Form.Item
            name="email"
